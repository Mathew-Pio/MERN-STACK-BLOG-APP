  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <img src={imageFileUrl || currentUser.profilePicture} alt="user" className={`rounded-full w-full border-8 h-full object-cover border-[lightgray] ${imageFileUploadProgess && imageFileUploadProgess < 100 && 'opacity-60'}`} />
            </div>
